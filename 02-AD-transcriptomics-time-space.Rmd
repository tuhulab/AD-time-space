...
openxlsx::write.xlsx(table_s1,
                     "data/supplementary/table_s1.xlsx")
```
...
## Space effect - Differential expressed genes: anotomic area (Figure 4b, 4)
...
```{r output figure 4c}
png("data/supplementary/figure_4c", width = 480 * 1.5, height = 480 * 1.5)
draw(heatmap_krtap, heatmap_legend_side = "right",
     annotation_legend_side = "top", merge_legend = FALSE)
dev.off()
```
