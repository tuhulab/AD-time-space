...
de_v1_c %>% readr::write_rds("data/de_v1_c.rds")
```
...
gsea_ad_p <-
  ...
  mutate(
    ...
    project = factor(project, levels = c("acute_chronic",
                                         "gse107361",
                                         "gse120721",
                                         "gse121212",
                                         "GENAD")),
...
regulatory_p <- 
  ((gsea_r_p / ncRNA_vp_P) | toptopncRNA_boxplot) + 
  plot_annotation(tag_levels = "a") & 
                  theme(plot.tag = element_text(face = "bold"))
ggsave("data/supplementary/figure_5a.jpeg", 
       gsea_r_p, width = 7, height = 4)
ggsave("data/supplementary/figure_5b.jpeg",
       ncRNA_vp_P)
ggsave("data/supplementary/figure_5c.jpeg",
       toptopncRNA_boxplot)
```

```{r output figure 5, eval=FALSE}
ggsave("data/supplementary/figure_5.png", regulatory_p, 
       height = 9.5, width = 14, dpi = "retina")
```
...
heatmap_mir <- ComplexHeatmap::Heatmap(heatmap_mir_data_m,
                        ...
                        show_row_names = T,
                        show_row_dend = FALSE,
                        row_names_gp = gpar(fontsize = min(9.5, 800 * 6 / dim(heatmap_mir_data)[1])),
...
png("data/supplementary/figure_s6a.png", 
    width = 480*6, height = 480*4, 
    res=300)
draw(heatmap_mir, heatmap_legend_side = "right",
     annotation_legend_side = "top", merge_legend = FALSE)
dev.off()
...
MIR31_CLDN1 <- 
  ...
  stat_cor()
ggsave("data/supplementary/figure_s6b.png", MIR31_CLDN1, width = 5, height = 5)
```
