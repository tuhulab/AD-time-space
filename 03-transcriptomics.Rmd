...
heatmap_annotation <- 
  HeatmapAnnotation(
    ...
    col = list(`Tissue type` = c("LS" = "#fc8d59", "NL" = "#ffffbf", "NN" = "#91cf60"),
               `Sampling site` = color),
...
# png("../multiomics-ad-phd-pres/Rmd/poster_gsiannualmeeting/heatmap.png", width = 480*8*1.5, height = 480*10*1.5, res=300)
# draw(heatmap, heatmap_legend_side = "right",
#      annotation_legend_side = "top", merge_legend = FALSE)
# dev.off()
