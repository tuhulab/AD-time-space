...
* `LSvsNN`: r r knitr::load_cache("DGE-V1", "n_de_v1_LSvsNN_up") up-regulated and r knitr::load_cache("DGE-V1", "n_de_v1_LSvsNN_down") down-regulated
...
```{r biopsy_area barplot, eval=FALSE}
...
se_deconvolute <- 
  se %>% deconvolve_cellularity(prefix="cibersort_", cores = 7)
