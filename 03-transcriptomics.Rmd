...
The atopic dermatitis (AD) group were characterized by mild to moderate disease severity, with mean eczema area and severity index (EASI) 4.2 and mean SCORing Atopic Dermatitis (SCORAD) 33.5. At the baseline, the AD and healthy control (HC) group showed no statistical difference in gender, age, BMI, and total blood IgE. Individual data points were reported in the supplementary table.
...
```{r include PCA 3d plot, dpi=300, out.width='100%'}
