...
gse107361 <- readr::read_rds("data/gse107361_dge.rds")
gse120721 <- readr::read_rds("data/gse120721_dge.rds") %>% mutate(project = )
...
# gsea_res %>% saveRDS("data/gsea_res_FOUR.rds")
```
