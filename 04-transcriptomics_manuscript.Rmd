...
vpcore_violin <-
  plotVarPart_internal(vp_core_p) + theme(plot.margin = margin(.5, 1, 0, 2, "cm"))
...
top_cytokine_p <- 
  ...
  ggboxplot(x = "skin_type", y = "counts_scaled", add = "jitter", 
            ...
            ylab = FALSE, color = "skin_type", 
            palette = pca_color, legend.title = "",
            font.legend = c(14), nrow = 1) +
  yscale("log10")

png("figure/vp_cytokine_boxplot.png", width = 480*6, height= 480*2, res = 300)
top_cytokine_p
dev.off()
