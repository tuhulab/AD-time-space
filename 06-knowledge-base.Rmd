...
### FGSEA
FGSEA gene set should be created as a list, containing named gene set names consisting of gene symbols.

#### Calculate rank
Use the stat generated from `DESeq2` stat (non-shirnked).