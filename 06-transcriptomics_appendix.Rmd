...
p_IL34_IL37_a <-
  novel_target_expr %>% 
  ggscatter(x = "IL34", y = "IL37", add = "reg.line", conf.int = T,
...
```{r}
novel_target_expr %>% 
  ggscatter(x = "IL34", y = "CSF1", add = "reg.line", conf.int = T,
            cor.coef = T, cor.method = "spearman")
```
...
novel_target_expr %>% 
  ggscatter(x = "IL34", y = "CSF1", add = "reg.line", conf.int = T, color = "skin_type",
            cor.coef = T, cor.method = "spearman", 
            facet.by = "skin_type", scale = "free", palette = pca_color)
```
...
```{r}
novel_target_expr %>% 
  ggscatter(x = "IL34", y = "CSF1R", add = "reg.line", conf.int = T,
            cor.coef = T, cor.method = "spearman")
```
