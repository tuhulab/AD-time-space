...
se_core <- se[c(intersect(rownames(se), core_genes), "IL36A"), 
...
time_variation_g <- 
  ...
  facet_wrap(~ .feature, scales = "free", nrow = 2) + 
  stat_summary(aes( group= skin_type), fun = mean, geom= "line", size = 2, alpha = .95) +
  scale_fill_manual(values = pca_color, name = "Tissue type") +
  scale_color_manual(values = pca_color, name = "Tissue type") +
  ylab("log2 counts") + 
  xlab("Quarter of visit") +
  theme_classic()
